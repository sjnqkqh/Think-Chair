...
- 생성된 답변 (Generated Answer): {answer}""",
    ...
    async def run_batch_evaluation(
        ...
        evaluation_history_record = self.create_evaluation_history(
            database_session, question, ground_truth
        )
        ...
        for strategy in strategies:
            ...
            evaluation_result = await self.run_evaluation_for_strategy(
                question=question,
                ground_truth=ground_truth,
                collection_name=collection_name,
                top_k=top_k,
    ...
    async def run_json_dataset_evaluation(
        self,
        database_session: Session,
        qa_pairs: List[Any],
        strategies: List[dict],
        ...
        async def evaluate_single_task(qa_item, strategy_item):
            ...
            eval_res = await self.run_evaluation_for_strategy(
