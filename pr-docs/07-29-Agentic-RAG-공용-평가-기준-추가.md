...
- `tests/evaluation/agentic_rag_corpus.jsonl`: 실제 사용자 자료를 사용하지 않는 검색·인용 평가용 합성 corpus
...
- `uv run pytest -q`: 182개 통과
- `uv run pytest tests/unit/evaluation/test_agentic_rag_eval.py -q`: 9개 통과
